...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget device(IconData icon, String name, int value, int index,List<String> rooms){
    return Padding(
              ...
              child:SingleChildScrollView(
                child:Column(
                  ...
                  children:[
                    ...
                    device(Icons.hvac,"Air Conditioning",3,1,["Living room","Bedroom","Kitchen"]),
                    device(Icons.lightbulb,"Lightings",2,2,["Living room","Kitchen"]),
                    device(Icons.key,"Door Locks",1,3,[]),
                    device(Icons.grass,"Automatic irrigation",3,4,["Living room","Kitchen","Balcony"]),
                  ]
                )
              )
            )
